...
- The canonical solution file is `ZiziBot.TelegramBot.slnx` (legacy `.sln` has been fully removed)
...
- For tech stack details, read `mem:tech_stack`
- For developer commands, read `mem:suggested_commands`
- For code conventions, read `mem:conventions`
- For verification steps, read `mem:task_completion`
